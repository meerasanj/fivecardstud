...
```
cd existing_repo
git remote add origin https://anvil.cs.mercer.edu/Sanjeevirao_mp/fivecardstud.git
git branch -M main
...
- [ ] [Set up project integrations](https://anvil.cs.mercer.edu/Sanjeevirao_mp/fivecardstud/-/settings/integrations)
